      ...
      <div className="grid items-center gap-10 lg:grid-cols-[1fr_1fr]">
        <div>
          ...
          <p className="mt-5 text-base leading-7 text-[#4a655a]">
            WINCARE is a compassionate health ministry committed to transforming
            lives by providing free and accessible healthcare to underprivileged
            communities. As the health arm of Word Impact Nation, a youth
            focused non-denominational ministry, we aim to make quality
            healthcare a universal right irrespective of socio-economic status.
          </p>
          <p className="mt-4 text-base leading-7 text-[#4a655a]">
            From health education to preventive care and outreach programs, we
            focus on practical solutions that strengthen families, protect
            vulnerable groups, and build healthier communities for the long
            term.
          </p>
