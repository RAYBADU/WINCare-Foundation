...
const FoundingStory = () => {
  return (
    <section className="mx-auto max-w-6xl px-4 py-16 md:px-8 lg:px-12">
      <motion.div
        className="overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#123928] via-[#1c4d43] to-[#0e2d2b] text-white shadow-[0_16px_40px_rgba(18,57,40,0.12)] md:shadow-[0_28px_60px_rgba(18,57,40,0.18)]"
      ...
      >
        <div className="grid gap-10 p-6 md:p-8 lg:grid-cols-[1.1fr_0.9fr] lg:p-12">
          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-8 space-y-4">
              {storyHighlights.map(({ icon: Icon, title, text }) => (
                ...
                >
                  <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-[#dff5ea] text-[#123928]">
          ...
          >
            {/* Decorative glow */}
            <div className="absolute inset-x-10 top-10 h-40 rounded-full bg-[#7ec9a6]/20 blur-none md:blur-3xl" />

            {/* Card */}
            <div className="relative w-full max-w-md rounded-[2rem] border border-white/10 bg-[#edf7ee] p-5 text-[#123928] shadow-[0_16px_35px_rgba(0,0,0,0.12)] md:shadow-[0_28px_60px_rgba(0,0,0,0.18)]">
