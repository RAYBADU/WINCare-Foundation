...
const outreachImages = [
  {
    src: heroImage1,
    alt: "A Picture of a community outreach program in action, with volunteers.",
    label: "",
  },
  {
    src: heroImage2,
        ...
        >
          ...
          >
            ...
            <div className="mt-8 flex flex-wrap items-center gap-4">
              <a
                href="#"
                className="group inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#5baa8a] to-[#4a9577] px-6 py-3.5 text-sm font-semibold text-white shadow-[0_8px_24px_rgba(91,170,138,0.3)] transition-all hover:shadow-[0_12px_32px_rgba(91,170,138,0.4)] duration-300 hover:bg-[#4A9679] hover:scale-105 active:scale-95"
              >
                Donate today
              ...
              <a
                href="#"
                className="inline-flex items-center gap-2 rounded-full border-2 border-[#5baa8a] bg-white px-6 py-3.5 text-sm font-semibold text-[#2e7d5a] shadow-[0_4px_12px_rgba(18,57,40,0.08)] transition-all hover:border-[#4a9577] hover:bg-[#f0fdf6] hover:shadow-[0_8px_20px_rgba(91,170,138,0.15)] active:scale-95"
              >
                Explore outreach
              </a>
            </div>
